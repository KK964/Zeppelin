<template>
  <div class="privacy-policy">
    <div class="wrapper">
      <h1>TBH Manager Privacy Policy</h1>

      <h2>TBH Manager overview</h2>
      <p>
        TBH Manager is a moderation bot for Discord that allows server staff to
      ...
      <p>
        ...
        <a href="https://github.com/KK964/ZeppelinBot">
          https://github.com/KK964/ZeppelinBot
        </a>
      </p>

      <h2>Stored data</h2>
      <p>
        When TBH Manager is used by a server, the following categories data can be
        stored by the bot.
        The specific categories of data saved for each server depends on how the
        server has configured TBH Manager.
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>Infraction record data is kept until the server stops using TBH Manager
        ...
        <li>User information for users logged in to the bot's web dashboard via
          Discord OAuth is stored as long as the server uses TBH Manager
        </li>
      </ul>
